...
###  ZENO-ENGINE
#################
set(CONAN_ZENO-ENGINE_ROOT "C:/Users/Mark/.conan/data/zeno-engine/0.15/mark.davison/stable/package/7ab81a98195a432d72e63daf80054b98156d3ede")
set(CONAN_INCLUDE_DIRS_ZENO-ENGINE "C:/Users/Mark/.conan/data/zeno-engine/0.15/mark.davison/stable/package/7ab81a98195a432d72e63daf80054b98156d3ede/include")
set(CONAN_LIB_DIRS_ZENO-ENGINE "C:/Users/Mark/.conan/data/zeno-engine/0.15/mark.davison/stable/package/7ab81a98195a432d72e63daf80054b98156d3ede/lib")
set(CONAN_BIN_DIRS_ZENO-ENGINE )
set(CONAN_RES_DIRS_ZENO-ENGINE )
set(CONAN_SRC_DIRS_ZENO-ENGINE )
set(CONAN_BUILD_DIRS_ZENO-ENGINE "C:/Users/Mark/.conan/data/zeno-engine/0.15/mark.davison/stable/package/7ab81a98195a432d72e63daf80054b98156d3ede/")
set(CONAN_FRAMEWORK_DIRS_ZENO-ENGINE )
set(CONAN_LIBS_ZENO-ENGINE )
set(CONAN_PKG_LIBS_ZENO-ENGINE )
set(CONAN_SYSTEM_LIBS_ZENO-ENGINE )
set(CONAN_FRAMEWORKS_ZENO-ENGINE )
set(CONAN_FRAMEWORKS_FOUND_ZENO-ENGINE "")  # Will be filled later
set(CONAN_DEFINES_ZENO-ENGINE )
set(CONAN_BUILD_MODULES_PATHS_ZENO-ENGINE )
# COMPILE_DEFINITIONS are equal to CONAN_DEFINES without -D, for targets
set(CONAN_COMPILE_DEFINITIONS_ZENO-ENGINE )

set(CONAN_C_FLAGS_ZENO-ENGINE "")
set(CONAN_CXX_FLAGS_ZENO-ENGINE "")
set(CONAN_SHARED_LINKER_FLAGS_ZENO-ENGINE "")
set(CONAN_EXE_LINKER_FLAGS_ZENO-ENGINE "")

# For modern cmake targets we use the list variables (separated with ;)
set(CONAN_C_FLAGS_ZENO-ENGINE_LIST "")
set(CONAN_CXX_FLAGS_ZENO-ENGINE_LIST "")
set(CONAN_SHARED_LINKER_FLAGS_ZENO-ENGINE_LIST "")
set(CONAN_EXE_LINKER_FLAGS_ZENO-ENGINE_LIST "")

# Apple Frameworks
conan_find_apple_frameworks(CONAN_FRAMEWORKS_FOUND_ZENO-ENGINE "${CONAN_FRAMEWORKS_ZENO-ENGINE}" "_ZENO-ENGINE" "")
# Append to aggregated values variable
set(CONAN_LIBS_ZENO-ENGINE ${CONAN_PKG_LIBS_ZENO-ENGINE} ${CONAN_SYSTEM_LIBS_ZENO-ENGINE} ${CONAN_FRAMEWORKS_FOUND_ZENO-ENGINE})


#################
###  ZENO-ENGINE
#################
set(CONAN_ZENO-ENGINE_ROOT_RELEASE "C:/Users/Mark/.conan/data/zeno-engine/0.15/mark.davison/stable/package/7ab81a98195a432d72e63daf80054b98156d3ede")
set(CONAN_INCLUDE_DIRS_ZENO-ENGINE_RELEASE "C:/Users/Mark/.conan/data/zeno-engine/0.15/mark.davison/stable/package/7ab81a98195a432d72e63daf80054b98156d3ede/include")
set(CONAN_LIB_DIRS_ZENO-ENGINE_RELEASE "C:/Users/Mark/.conan/data/zeno-engine/0.15/mark.davison/stable/package/7ab81a98195a432d72e63daf80054b98156d3ede/lib")
set(CONAN_BIN_DIRS_ZENO-ENGINE_RELEASE )
set(CONAN_RES_DIRS_ZENO-ENGINE_RELEASE )
set(CONAN_SRC_DIRS_ZENO-ENGINE_RELEASE )
set(CONAN_BUILD_DIRS_ZENO-ENGINE_RELEASE "C:/Users/Mark/.conan/data/zeno-engine/0.15/mark.davison/stable/package/7ab81a98195a432d72e63daf80054b98156d3ede/")
set(CONAN_FRAMEWORK_DIRS_ZENO-ENGINE_RELEASE )
set(CONAN_LIBS_ZENO-ENGINE_RELEASE zeno-engine-core-s zeno-engine-utility-s zeno-engine-core zeno-engine-utility)
set(CONAN_PKG_LIBS_ZENO-ENGINE_RELEASE zeno-engine-core-s zeno-engine-utility-s zeno-engine-core zeno-engine-utility)
set(CONAN_SYSTEM_LIBS_ZENO-ENGINE_RELEASE )
set(CONAN_FRAMEWORKS_ZENO-ENGINE_RELEASE )
set(CONAN_FRAMEWORKS_FOUND_ZENO-ENGINE_RELEASE "")  # Will be filled later
set(CONAN_DEFINES_ZENO-ENGINE_RELEASE )
set(CONAN_BUILD_MODULES_PATHS_ZENO-ENGINE_RELEASE )
# COMPILE_DEFINITIONS are equal to CONAN_DEFINES without -D, for targets
set(CONAN_COMPILE_DEFINITIONS_ZENO-ENGINE_RELEASE )

set(CONAN_C_FLAGS_ZENO-ENGINE_RELEASE "")
set(CONAN_CXX_FLAGS_ZENO-ENGINE_RELEASE "")
set(CONAN_SHARED_LINKER_FLAGS_ZENO-ENGINE_RELEASE "")
set(CONAN_EXE_LINKER_FLAGS_ZENO-ENGINE_RELEASE "")

# For modern cmake targets we use the list variables (separated with ;)
set(CONAN_C_FLAGS_ZENO-ENGINE_RELEASE_LIST "")
set(CONAN_CXX_FLAGS_ZENO-ENGINE_RELEASE_LIST "")
set(CONAN_SHARED_LINKER_FLAGS_ZENO-ENGINE_RELEASE_LIST "")
set(CONAN_EXE_LINKER_FLAGS_ZENO-ENGINE_RELEASE_LIST "")

# Apple Frameworks
conan_find_apple_frameworks(CONAN_FRAMEWORKS_FOUND_ZENO-ENGINE_RELEASE "${CONAN_FRAMEWORKS_ZENO-ENGINE_RELEASE}" "_ZENO-ENGINE" "_RELEASE")
# Append to aggregated values variable
set(CONAN_LIBS_ZENO-ENGINE_RELEASE ${CONAN_PKG_LIBS_ZENO-ENGINE_RELEASE} ${CONAN_SYSTEM_LIBS_ZENO-ENGINE_RELEASE} ${CONAN_FRAMEWORKS_FOUND_ZENO-ENGINE_RELEASE})


#################
###  ZENO-ENGINE
#################
set(CONAN_ZENO-ENGINE_ROOT_DEBUG "C:/Users/Mark/.conan/data/zeno-engine/0.15/mark.davison/stable/package/7ab81a98195a432d72e63daf80054b98156d3ede")
set(CONAN_INCLUDE_DIRS_ZENO-ENGINE_DEBUG "C:/Users/Mark/.conan/data/zeno-engine/0.15/mark.davison/stable/package/7ab81a98195a432d72e63daf80054b98156d3ede/include")
set(CONAN_LIB_DIRS_ZENO-ENGINE_DEBUG "C:/Users/Mark/.conan/data/zeno-engine/0.15/mark.davison/stable/package/7ab81a98195a432d72e63daf80054b98156d3ede/lib")
set(CONAN_BIN_DIRS_ZENO-ENGINE_DEBUG )
set(CONAN_RES_DIRS_ZENO-ENGINE_DEBUG )
set(CONAN_SRC_DIRS_ZENO-ENGINE_DEBUG )
set(CONAN_BUILD_DIRS_ZENO-ENGINE_DEBUG "C:/Users/Mark/.conan/data/zeno-engine/0.15/mark.davison/stable/package/7ab81a98195a432d72e63daf80054b98156d3ede/")
set(CONAN_FRAMEWORK_DIRS_ZENO-ENGINE_DEBUG )
set(CONAN_LIBS_ZENO-ENGINE_DEBUG zeno-engine-core-s-d zeno-engine-utility-s-d zeno-engine-core-d zeno-engine-utility-d)
set(CONAN_PKG_LIBS_ZENO-ENGINE_DEBUG zeno-engine-core-s-d zeno-engine-utility-s-d zeno-engine-core-d zeno-engine-utility-d)
set(CONAN_SYSTEM_LIBS_ZENO-ENGINE_DEBUG )
set(CONAN_FRAMEWORKS_ZENO-ENGINE_DEBUG )
set(CONAN_FRAMEWORKS_FOUND_ZENO-ENGINE_DEBUG "")  # Will be filled later
set(CONAN_DEFINES_ZENO-ENGINE_DEBUG )
set(CONAN_BUILD_MODULES_PATHS_ZENO-ENGINE_DEBUG )
# COMPILE_DEFINITIONS are equal to CONAN_DEFINES without -D, for targets
set(CONAN_COMPILE_DEFINITIONS_ZENO-ENGINE_DEBUG )

set(CONAN_C_FLAGS_ZENO-ENGINE_DEBUG "")
set(CONAN_CXX_FLAGS_ZENO-ENGINE_DEBUG "")
set(CONAN_SHARED_LINKER_FLAGS_ZENO-ENGINE_DEBUG "")
set(CONAN_EXE_LINKER_FLAGS_ZENO-ENGINE_DEBUG "")

# For modern cmake targets we use the list variables (separated with ;)
set(CONAN_C_FLAGS_ZENO-ENGINE_DEBUG_LIST "")
set(CONAN_CXX_FLAGS_ZENO-ENGINE_DEBUG_LIST "")
set(CONAN_SHARED_LINKER_FLAGS_ZENO-ENGINE_DEBUG_LIST "")
set(CONAN_EXE_LINKER_FLAGS_ZENO-ENGINE_DEBUG_LIST "")

# Apple Frameworks
conan_find_apple_frameworks(CONAN_FRAMEWORKS_FOUND_ZENO-ENGINE_DEBUG "${CONAN_FRAMEWORKS_ZENO-ENGINE_DEBUG}" "_ZENO-ENGINE" "_DEBUG")
# Append to aggregated values variable
set(CONAN_LIBS_ZENO-ENGINE_DEBUG ${CONAN_PKG_LIBS_ZENO-ENGINE_DEBUG} ${CONAN_SYSTEM_LIBS_ZENO-ENGINE_DEBUG} ${CONAN_FRAMEWORKS_FOUND_ZENO-ENGINE_DEBUG})


#################
###  GLFW
#################
set(CONAN_GLFW_ROOT "C:/Users/Mark/.conan/data/glfw/3.3.5/_/_/package/72e84aac9213a09dfb0f59578ae9423a2eb326e7")
set(CONAN_INCLUDE_DIRS_GLFW "C:/Users/Mark/.conan/data/glfw/3.3.5/_/_/package/72e84aac9213a09dfb0f59578ae9423a2eb326e7/include")
set(CONAN_LIB_DIRS_GLFW "C:/Users/Mark/.conan/data/glfw/3.3.5/_/_/package/72e84aac9213a09dfb0f59578ae9423a2eb326e7/lib")
set(CONAN_BIN_DIRS_GLFW )
set(CONAN_RES_DIRS_GLFW )
set(CONAN_SRC_DIRS_GLFW )
set(CONAN_BUILD_DIRS_GLFW "C:/Users/Mark/.conan/data/glfw/3.3.5/_/_/package/72e84aac9213a09dfb0f59578ae9423a2eb326e7/"
			"C:/Users/Mark/.conan/data/glfw/3.3.5/_/_/package/72e84aac9213a09dfb0f59578ae9423a2eb326e7/lib/cmake")
...
set(CONAN_BUILD_MODULES_PATHS_GLFW "C:/Users/Mark/.conan/data/glfw/3.3.5/_/_/package/72e84aac9213a09dfb0f59578ae9423a2eb326e7/lib/cmake/conan-official-glfw-targets.cmake")
# COMPILE_DEFINITIONS are equal to CONAN_DEFINES without -D, for targets
...
###  CATCH2
#################
set(CONAN_CATCH2_ROOT "C:/Users/Mark/.conan/data/catch2/2.13.6/_/_/package/5ab84d6acfe1f23c4fae0ab88f26e3a396351ac9")
set(CONAN_INCLUDE_DIRS_CATCH2 "C:/Users/Mark/.conan/data/catch2/2.13.6/_/_/package/5ab84d6acfe1f23c4fae0ab88f26e3a396351ac9/include")
set(CONAN_LIB_DIRS_CATCH2 "C:/Users/Mark/.conan/data/catch2/2.13.6/_/_/package/5ab84d6acfe1f23c4fae0ab88f26e3a396351ac9/lib")
set(CONAN_BIN_DIRS_CATCH2 )
set(CONAN_RES_DIRS_CATCH2 )
set(CONAN_SRC_DIRS_CATCH2 )
set(CONAN_BUILD_DIRS_CATCH2 "C:/Users/Mark/.conan/data/catch2/2.13.6/_/_/package/5ab84d6acfe1f23c4fae0ab88f26e3a396351ac9/lib/cmake/Catch2")
...
###  OPENGL
#################
set(CONAN_OPENGL_ROOT "C:/Users/Mark/.conan/data/opengl/system/_/_/package/5ab84d6acfe1f23c4fae0ab88f26e3a396351ac9")
...
set(CONAN_BUILD_DIRS_OPENGL "C:/Users/Mark/.conan/data/opengl/system/_/_/package/5ab84d6acfe1f23c4fae0ab88f26e3a396351ac9/")
...
set(CONAN_DEPENDENCIES zeno-engine glfw catch2 opengl)
...
set(CONAN_INCLUDE_DIRS "C:/Users/Mark/.conan/data/zeno-engine/0.15/mark.davison/stable/package/7ab81a98195a432d72e63daf80054b98156d3ede/include"
			"C:/Users/Mark/.conan/data/glfw/3.3.5/_/_/package/72e84aac9213a09dfb0f59578ae9423a2eb326e7/include"
			"C:/Users/Mark/.conan/data/catch2/2.13.6/_/_/package/5ab84d6acfe1f23c4fae0ab88f26e3a396351ac9/include" ${CONAN_INCLUDE_DIRS})
set(CONAN_LIB_DIRS "C:/Users/Mark/.conan/data/zeno-engine/0.15/mark.davison/stable/package/7ab81a98195a432d72e63daf80054b98156d3ede/lib"
			"C:/Users/Mark/.conan/data/glfw/3.3.5/_/_/package/72e84aac9213a09dfb0f59578ae9423a2eb326e7/lib"
			"C:/Users/Mark/.conan/data/catch2/2.13.6/_/_/package/5ab84d6acfe1f23c4fae0ab88f26e3a396351ac9/lib" ${CONAN_LIB_DIRS})
...
set(CONAN_BUILD_MODULES_PATHS "C:/Users/Mark/.conan/data/glfw/3.3.5/_/_/package/72e84aac9213a09dfb0f59578ae9423a2eb326e7/lib/cmake/conan-official-glfw-targets.cmake" ${CONAN_BUILD_MODULES_PATHS})
set(CONAN_CMAKE_MODULE_PATH "C:/Users/Mark/.conan/data/zeno-engine/0.15/mark.davison/stable/package/7ab81a98195a432d72e63daf80054b98156d3ede/"
			"C:/Users/Mark/.conan/data/glfw/3.3.5/_/_/package/72e84aac9213a09dfb0f59578ae9423a2eb326e7/"
			"C:/Users/Mark/.conan/data/glfw/3.3.5/_/_/package/72e84aac9213a09dfb0f59578ae9423a2eb326e7/lib/cmake"
			"C:/Users/Mark/.conan/data/catch2/2.13.6/_/_/package/5ab84d6acfe1f23c4fae0ab88f26e3a396351ac9/lib/cmake/Catch2"
			"C:/Users/Mark/.conan/data/opengl/system/_/_/package/5ab84d6acfe1f23c4fae0ab88f26e3a396351ac9/" ${CONAN_CMAKE_MODULE_PATH})
...
set(CONAN_INCLUDE_DIRS_RELEASE "C:/Users/Mark/.conan/data/zeno-engine/0.15/mark.davison/stable/package/7ab81a98195a432d72e63daf80054b98156d3ede/include" ${CONAN_INCLUDE_DIRS_RELEASE})
set(CONAN_LIB_DIRS_RELEASE "C:/Users/Mark/.conan/data/zeno-engine/0.15/mark.davison/stable/package/7ab81a98195a432d72e63daf80054b98156d3ede/lib" ${CONAN_LIB_DIRS_RELEASE})
...
set(CONAN_LIBS_RELEASE zeno-engine-core-s zeno-engine-utility-s zeno-engine-core zeno-engine-utility ${CONAN_LIBS_RELEASE})
set(CONAN_PKG_LIBS_RELEASE zeno-engine-core-s zeno-engine-utility-s zeno-engine-core zeno-engine-utility ${CONAN_PKG_LIBS_RELEASE})
...
set(CONAN_CMAKE_MODULE_PATH_RELEASE "C:/Users/Mark/.conan/data/zeno-engine/0.15/mark.davison/stable/package/7ab81a98195a432d72e63daf80054b98156d3ede/" ${CONAN_CMAKE_MODULE_PATH_RELEASE})
...
set(CONAN_INCLUDE_DIRS_DEBUG "C:/Users/Mark/.conan/data/zeno-engine/0.15/mark.davison/stable/package/7ab81a98195a432d72e63daf80054b98156d3ede/include" ${CONAN_INCLUDE_DIRS_DEBUG})
set(CONAN_LIB_DIRS_DEBUG "C:/Users/Mark/.conan/data/zeno-engine/0.15/mark.davison/stable/package/7ab81a98195a432d72e63daf80054b98156d3ede/lib" ${CONAN_LIB_DIRS_DEBUG})
...
set(CONAN_LIBS_DEBUG zeno-engine-core-s-d zeno-engine-utility-s-d zeno-engine-core-d zeno-engine-utility-d ${CONAN_LIBS_DEBUG})
set(CONAN_PKG_LIBS_DEBUG zeno-engine-core-s-d zeno-engine-utility-s-d zeno-engine-core-d zeno-engine-utility-d ${CONAN_PKG_LIBS_DEBUG})
...
set(CONAN_CMAKE_MODULE_PATH_DEBUG "C:/Users/Mark/.conan/data/zeno-engine/0.15/mark.davison/stable/package/7ab81a98195a432d72e63daf80054b98156d3ede/" ${CONAN_CMAKE_MODULE_PATH_DEBUG})
...
macro(conan_define_targets)
    ...
    set(_CONAN_PKG_LIBS_ZENO-ENGINE_DEPENDENCIES "${CONAN_SYSTEM_LIBS_ZENO-ENGINE} ${CONAN_FRAMEWORKS_FOUND_ZENO-ENGINE} CONAN_PKG::catch2 CONAN_PKG::glfw")
    string(REPLACE " " ";" _CONAN_PKG_LIBS_ZENO-ENGINE_DEPENDENCIES "${_CONAN_PKG_LIBS_ZENO-ENGINE_DEPENDENCIES}")
    conan_package_library_targets("${CONAN_PKG_LIBS_ZENO-ENGINE}" "${CONAN_LIB_DIRS_ZENO-ENGINE}"
                                  CONAN_PACKAGE_TARGETS_ZENO-ENGINE "${_CONAN_PKG_LIBS_ZENO-ENGINE_DEPENDENCIES}"
                                  "" zeno-engine)
    set(_CONAN_PKG_LIBS_ZENO-ENGINE_DEPENDENCIES_DEBUG "${CONAN_SYSTEM_LIBS_ZENO-ENGINE_DEBUG} ${CONAN_FRAMEWORKS_FOUND_ZENO-ENGINE_DEBUG} CONAN_PKG::catch2 CONAN_PKG::glfw")
    string(REPLACE " " ";" _CONAN_PKG_LIBS_ZENO-ENGINE_DEPENDENCIES_DEBUG "${_CONAN_PKG_LIBS_ZENO-ENGINE_DEPENDENCIES_DEBUG}")
    conan_package_library_targets("${CONAN_PKG_LIBS_ZENO-ENGINE_DEBUG}" "${CONAN_LIB_DIRS_ZENO-ENGINE_DEBUG}"
                                  CONAN_PACKAGE_TARGETS_ZENO-ENGINE_DEBUG "${_CONAN_PKG_LIBS_ZENO-ENGINE_DEPENDENCIES_DEBUG}"
                                  "debug" zeno-engine)
    set(_CONAN_PKG_LIBS_ZENO-ENGINE_DEPENDENCIES_RELEASE "${CONAN_SYSTEM_LIBS_ZENO-ENGINE_RELEASE} ${CONAN_FRAMEWORKS_FOUND_ZENO-ENGINE_RELEASE} CONAN_PKG::catch2 CONAN_PKG::glfw")
    string(REPLACE " " ";" _CONAN_PKG_LIBS_ZENO-ENGINE_DEPENDENCIES_RELEASE "${_CONAN_PKG_LIBS_ZENO-ENGINE_DEPENDENCIES_RELEASE}")
    conan_package_library_targets("${CONAN_PKG_LIBS_ZENO-ENGINE_RELEASE}" "${CONAN_LIB_DIRS_ZENO-ENGINE_RELEASE}"
                                  CONAN_PACKAGE_TARGETS_ZENO-ENGINE_RELEASE "${_CONAN_PKG_LIBS_ZENO-ENGINE_DEPENDENCIES_RELEASE}"
                                  "release" zeno-engine)
    set(_CONAN_PKG_LIBS_ZENO-ENGINE_DEPENDENCIES_RELWITHDEBINFO "${CONAN_SYSTEM_LIBS_ZENO-ENGINE_RELWITHDEBINFO} ${CONAN_FRAMEWORKS_FOUND_ZENO-ENGINE_RELWITHDEBINFO} CONAN_PKG::catch2 CONAN_PKG::glfw")
    string(REPLACE " " ";" _CONAN_PKG_LIBS_ZENO-ENGINE_DEPENDENCIES_RELWITHDEBINFO "${_CONAN_PKG_LIBS_ZENO-ENGINE_DEPENDENCIES_RELWITHDEBINFO}")
    conan_package_library_targets("${CONAN_PKG_LIBS_ZENO-ENGINE_RELWITHDEBINFO}" "${CONAN_LIB_DIRS_ZENO-ENGINE_RELWITHDEBINFO}"
                                  CONAN_PACKAGE_TARGETS_ZENO-ENGINE_RELWITHDEBINFO "${_CONAN_PKG_LIBS_ZENO-ENGINE_DEPENDENCIES_RELWITHDEBINFO}"
                                  "relwithdebinfo" zeno-engine)
    set(_CONAN_PKG_LIBS_ZENO-ENGINE_DEPENDENCIES_MINSIZEREL "${CONAN_SYSTEM_LIBS_ZENO-ENGINE_MINSIZEREL} ${CONAN_FRAMEWORKS_FOUND_ZENO-ENGINE_MINSIZEREL} CONAN_PKG::catch2 CONAN_PKG::glfw")
    string(REPLACE " " ";" _CONAN_PKG_LIBS_ZENO-ENGINE_DEPENDENCIES_MINSIZEREL "${_CONAN_PKG_LIBS_ZENO-ENGINE_DEPENDENCIES_MINSIZEREL}")
    conan_package_library_targets("${CONAN_PKG_LIBS_ZENO-ENGINE_MINSIZEREL}" "${CONAN_LIB_DIRS_ZENO-ENGINE_MINSIZEREL}"
                                  CONAN_PACKAGE_TARGETS_ZENO-ENGINE_MINSIZEREL "${_CONAN_PKG_LIBS_ZENO-ENGINE_DEPENDENCIES_MINSIZEREL}"
                                  "minsizerel" zeno-engine)

    add_library(CONAN_PKG::zeno-engine INTERFACE IMPORTED)

    # Property INTERFACE_LINK_FLAGS do not work, necessary to add to INTERFACE_LINK_LIBRARIES
    set_property(TARGET CONAN_PKG::zeno-engine PROPERTY INTERFACE_LINK_LIBRARIES ${CONAN_PACKAGE_TARGETS_ZENO-ENGINE} ${_CONAN_PKG_LIBS_ZENO-ENGINE_DEPENDENCIES}
                                                                 $<$<STREQUAL:$<TARGET_PROPERTY:TYPE>,SHARED_LIBRARY>:${CONAN_SHARED_LINKER_FLAGS_ZENO-ENGINE_LIST}>
                                                                 $<$<STREQUAL:$<TARGET_PROPERTY:TYPE>,MODULE_LIBRARY>:${CONAN_SHARED_LINKER_FLAGS_ZENO-ENGINE_LIST}>
                                                                 $<$<STREQUAL:$<TARGET_PROPERTY:TYPE>,EXECUTABLE>:${CONAN_EXE_LINKER_FLAGS_ZENO-ENGINE_LIST}>

                                                                 $<$<CONFIG:Release>:${CONAN_PACKAGE_TARGETS_ZENO-ENGINE_RELEASE} ${_CONAN_PKG_LIBS_ZENO-ENGINE_DEPENDENCIES_RELEASE}
                                                                 $<$<STREQUAL:$<TARGET_PROPERTY:TYPE>,SHARED_LIBRARY>:${CONAN_SHARED_LINKER_FLAGS_ZENO-ENGINE_RELEASE_LIST}>
                                                                 $<$<STREQUAL:$<TARGET_PROPERTY:TYPE>,MODULE_LIBRARY>:${CONAN_SHARED_LINKER_FLAGS_ZENO-ENGINE_RELEASE_LIST}>
                                                                 $<$<STREQUAL:$<TARGET_PROPERTY:TYPE>,EXECUTABLE>:${CONAN_EXE_LINKER_FLAGS_ZENO-ENGINE_RELEASE_LIST}>>

                                                                 $<$<CONFIG:RelWithDebInfo>:${CONAN_PACKAGE_TARGETS_ZENO-ENGINE_RELWITHDEBINFO} ${_CONAN_PKG_LIBS_ZENO-ENGINE_DEPENDENCIES_RELWITHDEBINFO}
                                                                 $<$<STREQUAL:$<TARGET_PROPERTY:TYPE>,SHARED_LIBRARY>:${CONAN_SHARED_LINKER_FLAGS_ZENO-ENGINE_RELWITHDEBINFO_LIST}>
                                                                 $<$<STREQUAL:$<TARGET_PROPERTY:TYPE>,MODULE_LIBRARY>:${CONAN_SHARED_LINKER_FLAGS_ZENO-ENGINE_RELWITHDEBINFO_LIST}>
                                                                 $<$<STREQUAL:$<TARGET_PROPERTY:TYPE>,EXECUTABLE>:${CONAN_EXE_LINKER_FLAGS_ZENO-ENGINE_RELWITHDEBINFO_LIST}>>

                                                                 $<$<CONFIG:MinSizeRel>:${CONAN_PACKAGE_TARGETS_ZENO-ENGINE_MINSIZEREL} ${_CONAN_PKG_LIBS_ZENO-ENGINE_DEPENDENCIES_MINSIZEREL}
                                                                 $<$<STREQUAL:$<TARGET_PROPERTY:TYPE>,SHARED_LIBRARY>:${CONAN_SHARED_LINKER_FLAGS_ZENO-ENGINE_MINSIZEREL_LIST}>
                                                                 $<$<STREQUAL:$<TARGET_PROPERTY:TYPE>,MODULE_LIBRARY>:${CONAN_SHARED_LINKER_FLAGS_ZENO-ENGINE_MINSIZEREL_LIST}>
                                                                 $<$<STREQUAL:$<TARGET_PROPERTY:TYPE>,EXECUTABLE>:${CONAN_EXE_LINKER_FLAGS_ZENO-ENGINE_MINSIZEREL_LIST}>>

                                                                 $<$<CONFIG:Debug>:${CONAN_PACKAGE_TARGETS_ZENO-ENGINE_DEBUG} ${_CONAN_PKG_LIBS_ZENO-ENGINE_DEPENDENCIES_DEBUG}
                                                                 $<$<STREQUAL:$<TARGET_PROPERTY:TYPE>,SHARED_LIBRARY>:${CONAN_SHARED_LINKER_FLAGS_ZENO-ENGINE_DEBUG_LIST}>
                                                                 $<$<STREQUAL:$<TARGET_PROPERTY:TYPE>,MODULE_LIBRARY>:${CONAN_SHARED_LINKER_FLAGS_ZENO-ENGINE_DEBUG_LIST}>
                                                                 $<$<STREQUAL:$<TARGET_PROPERTY:TYPE>,EXECUTABLE>:${CONAN_EXE_LINKER_FLAGS_ZENO-ENGINE_DEBUG_LIST}>>)
    set_property(TARGET CONAN_PKG::zeno-engine PROPERTY INTERFACE_INCLUDE_DIRECTORIES ${CONAN_INCLUDE_DIRS_ZENO-ENGINE}
                                                                      $<$<CONFIG:Release>:${CONAN_INCLUDE_DIRS_ZENO-ENGINE_RELEASE}>
                                                                      $<$<CONFIG:RelWithDebInfo>:${CONAN_INCLUDE_DIRS_ZENO-ENGINE_RELWITHDEBINFO}>
                                                                      $<$<CONFIG:MinSizeRel>:${CONAN_INCLUDE_DIRS_ZENO-ENGINE_MINSIZEREL}>
                                                                      $<$<CONFIG:Debug>:${CONAN_INCLUDE_DIRS_ZENO-ENGINE_DEBUG}>)
    set_property(TARGET CONAN_PKG::zeno-engine PROPERTY INTERFACE_COMPILE_DEFINITIONS ${CONAN_COMPILE_DEFINITIONS_ZENO-ENGINE}
                                                                      $<$<CONFIG:Release>:${CONAN_COMPILE_DEFINITIONS_ZENO-ENGINE_RELEASE}>
                                                                      $<$<CONFIG:RelWithDebInfo>:${CONAN_COMPILE_DEFINITIONS_ZENO-ENGINE_RELWITHDEBINFO}>
                                                                      $<$<CONFIG:MinSizeRel>:${CONAN_COMPILE_DEFINITIONS_ZENO-ENGINE_MINSIZEREL}>
                                                                      $<$<CONFIG:Debug>:${CONAN_COMPILE_DEFINITIONS_ZENO-ENGINE_DEBUG}>)
    set_property(TARGET CONAN_PKG::zeno-engine PROPERTY INTERFACE_COMPILE_OPTIONS ${CONAN_C_FLAGS_ZENO-ENGINE_LIST} ${CONAN_CXX_FLAGS_ZENO-ENGINE_LIST}
                                                                  $<$<CONFIG:Release>:${CONAN_C_FLAGS_ZENO-ENGINE_RELEASE_LIST} ${CONAN_CXX_FLAGS_ZENO-ENGINE_RELEASE_LIST}>
                                                                  $<$<CONFIG:RelWithDebInfo>:${CONAN_C_FLAGS_ZENO-ENGINE_RELWITHDEBINFO_LIST} ${CONAN_CXX_FLAGS_ZENO-ENGINE_RELWITHDEBINFO_LIST}>
                                                                  $<$<CONFIG:MinSizeRel>:${CONAN_C_FLAGS_ZENO-ENGINE_MINSIZEREL_LIST} ${CONAN_CXX_FLAGS_ZENO-ENGINE_MINSIZEREL_LIST}>
                                                                  $<$<CONFIG:Debug>:${CONAN_C_FLAGS_ZENO-ENGINE_DEBUG_LIST}  ${CONAN_CXX_FLAGS_ZENO-ENGINE_DEBUG_LIST}>)
    ...
    set(CONAN_TARGETS CONAN_PKG::zeno-engine CONAN_PKG::glfw CONAN_PKG::catch2 CONAN_PKG::opengl)
