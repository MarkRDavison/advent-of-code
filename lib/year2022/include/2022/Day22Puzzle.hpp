...
namespace TwentyTwentyTwo {
	...
	using Adjacency = std::unordered_map<ze::Vector2i, std::unordered_map<core::Orientation, ze::Vector2i>, vector2_hash_fxn_TODO_CORE_ME4<int>>;
	using OrientationAdjacency = std::unordered_map<ze::Vector2i, std::unordered_map<core::Orientation, core::Orientation>, vector2_hash_fxn_TODO_CORE_ME4<int>>;
	...
	public:
		...
		static std::pair<Adjacency, OrientationAdjacency> processAdjacency3D(const Map& _map, int _cubeSize, const ze::Vector2i& _startingLocation);
