#ifndef INCLUDED_ZENO_ENGINE_CORE_VECTOR_MATH_HPP
#define INCLUDED_ZENO_ENGINE_CORE_VECTOR_MATH_HPP
...
#include <Core/VectorMath.inl>

#endif //~ INCLUDED_ZENO_ENGINE_CORE_VECTOR_MATH_HPP